class AppliesController < ApplicationController
  ...
  private
    ...
    def apply_params
      params.require(:apply).permit(:student_first_name, :student_last_name, :birth_date, :parent_first_name, :parent_last_name, :occupation, :phone_number, :relative_relation, :address, :med_description)
    end
end
